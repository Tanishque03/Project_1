...
function onMouseDown(event) {
    currentResize = event.target;
    const editor = currentResize.parentElement;
    const editorWidth = editor.offsetWidth;
    currentResize.style.left = `${editorWidth}px`; /* Set initial left position */
  ...
  function onMouseMove(event) {
    ...
    const editor = currentResize.parentElement;
    const newWidth = event.clientX - editor.offsetLeft; /* Calculate new width */
    currentResize.style.left = `${newWidth}px`;
    editor.style.width = `${newWidth}px`; /* Apply new width to container */
  }
